function sendWhatsApp(event) {
  ...
  const whatsappMessage = `Ciao, sono ${name}.`
   `Di: ${address} ${number}, ${country}. `
  ` Il mio numero di telefono è ${phone}. `
  ` Ho ordinato: ${order}. `
   `Vorrei che l'ordinazione fosse pronta per le ore: ${time}. ${message}`;
